...
const guitarRows = [
  ...
  [20, "The Dm chord", "Dm shape", "\"Mad World\" intro", completion("self_report"), "mad_world"],
...
const ukuleleRows = [
  ...
  [3, "The C chord", "one-finger chord", "\"Three Little Birds\" chorus", completion("count", "8 clean"), "three_little_birds"],
  ...
  [12, "The G chord", "three-finger triangle", "\"You Are My Sunshine\"", completion("count", "8 clean"), "you_are_my_sunshine"],
  [13, "\"Sunshine\" on uke", "C-F-G", "the song", completion("self_report"), "you_are_my_sunshine"],
  ...
  [20, "Reggae chuck", "muted upstroke", "\"Three Little Birds\" full", completion("self_report"), "three_little_birds"],
  [21, "\"Three Little Birds\" full", "application", "the song", completion("self_report"), "three_little_birds"],
