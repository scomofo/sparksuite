(function() {
  ...
  var CHARTS = {
    ...
    gtr_caged_intro_01: {
      ...
      totalBeats: 16,
      notes: [
        { beat: 0,  laneMask: 1,  label: "C-Cshp", skillId: "caged_intro" },
        { beat: 1,  laneMask: 1,  label: "C-Cshp", skillId: "caged_intro" },
        { beat: 2,  laneMask: 2,  label: "C-Ashp", skillId: "caged_intro" },
        { beat: 3,  laneMask: 2,  label: "C-Ashp", skillId: "caged_intro" },
        { beat: 4,  laneMask: 4,  label: "C-Gshp", skillId: "caged_intro" },
        { beat: 5,  laneMask: 4,  label: "C-Gshp", skillId: "caged_intro" },
        { beat: 6,  laneMask: 8,  label: "C-Eshp", skillId: "caged_intro" },
        { beat: 7,  laneMask: 8,  label: "C-Eshp", skillId: "caged_intro" },
        { beat: 8,  laneMask: 16, label: "C-Dshp", skillId: "caged_intro", flags: { specialPhrase: true } },
        { beat: 9,  laneMask: 16, label: "C-Dshp", skillId: "caged_intro", flags: { specialPhrase: true } },
        { beat: 10, laneMask: 8,  label: "C-Eshp", skillId: "caged_intro" },
        { beat: 11, laneMask: 8,  label: "C-Eshp", skillId: "caged_intro" },
        { beat: 12, laneMask: 4,  label: "C-Gshp", skillId: "caged_intro" },
        { beat: 13, laneMask: 4,  label: "C-Gshp", skillId: "caged_intro" },
        { beat: 14, laneMask: 2,  label: "C-Ashp", skillId: "caged_intro" },
        { beat: 15, laneMask: 1,  label: "C-Cshp", skillId: "caged_intro", flags: { specialPhrase: true } }
      ],
      phrases: [
