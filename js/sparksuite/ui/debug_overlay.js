...
(function () {
  ...
  SparkDebugOverlay.prototype._render = function () {
    ...
    var lines = [
      ...
      "FEEDBACK:   " + (d.feedback !== undefined && d.feedback !== null ? d.feedback : "--"),
      "CONFIDENCE: " + (d.confidence !== undefined ? d.confidence : "--"),
      "TIMING:     " + (d.timing !== undefined ? d.timing : "--"),
      "SCORE:      " + (d.score !== undefined ? d.score : "--"),
      "AI ERRORS:  " + (d.aiChordErrors ? d.aiChordErrors : "--"),
      "AI LATE:    " + (d.aiLateHits !== undefined ? d.aiLateHits : "--"),
      "AI EARLY:   " + (d.aiEarlyHits !== undefined ? d.aiEarlyHits : "--"),
