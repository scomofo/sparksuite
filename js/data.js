...
// ===== SONGS =====
var SONGS=[
  {title:"Three Little Birds",artist:"Bob Marley",chords:["A","D","E"],level:3,pattern:["D","D","U","U","D","U"],bpm:75,midi:"content/songs/midi/three_little_birds.mid",progression:["A","A","D","A","A","A","E","A"],leadNotes:[
  ...
  {title:"Knockin on Heavens Door",artist:"Bob Dylan",chords:["G","D","Am","C"],level:4,pattern:["D","D","U","U","D","U"],bpm:68,midi:"content/songs/midi/knockin_on_heavens_door.mid",progression:["G","D","Am","Am","G","D","C","C"]},
  {title:"Wonderful Tonight",artist:"Eric Clapton",chords:["G","D","C","Em"],level:4,pattern:["D","x","D","U","x","U","D","U"],bpm:95,midi:"content/songs/midi/wonderful_tonight.mid",progression:["G","D","C","D","G","D","C","D"]},
  {title:"Let It Be",artist:"The Beatles",chords:["C","G","Am","F"],level:7,pattern:["D","D","U","U","D","U"],bpm:72,midi:"content/songs/midi/let_it_be.mid",progression:["C","G","Am","F","C","G","F","C"]},
  {title:"Wish You Were Here",artist:"Pink Floyd",chords:["Em","G","A","C","D"],level:4,pattern:["D","x","U","x","U","D","x","U"],bpm:62,midi:"content/songs/midi/wish_you_were_here.mid",progression:["Em","G","Em","G","Em","A","Em","A","G","C","D","Am","G","D","C","Am"]},
  {title:"La Bamba",artist:"Ritchie Valens",chords:["C","F","G"],level:4,pattern:["D","D","U","U","D","U"],bpm:138,midi:"content/songs/midi/la_bamba.mid",progression:["C","F","G","G","C","F","G","G"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"C",t:0.00,dur:0.18,lane:0,laneMask:1},
    {note:"C",t:0.22,dur:0.18,lane:0,laneMask:1},
    {note:"F",t:0.43,dur:0.18,lane:1,laneMask:2},
    {note:"F",t:0.65,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:0.87,dur:0.18,lane:2,laneMask:4},
    {note:"G",t:1.09,dur:0.18,lane:2,laneMask:4},
    {note:"F",t:1.30,dur:0.18,lane:1,laneMask:2},
    {note:"C",t:1.58,dur:0.18,lane:0,laneMask:1},
    {note:"C",t:1.80,dur:0.18,lane:0,laneMask:1},
    {note:"F",t:2.01,dur:0.18,lane:1,laneMask:2},
    {note:"F",t:2.23,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:2.45,dur:0.18,lane:2,laneMask:4},
    {note:"G",t:2.67,dur:0.18,lane:2,laneMask:4},
    {note:"F",t:2.88,dur:0.18,lane:1,laneMask:2},
    {note:"C",t:3.16,dur:0.18,lane:0,laneMask:1},
    {note:"C",t:3.38,dur:0.18,lane:0,laneMask:1},
    {note:"F",t:3.59,dur:0.18,lane:1,laneMask:2},
    {note:"F",t:3.81,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:4.03,dur:0.18,lane:2,laneMask:4},
    {note:"G",t:4.25,dur:0.18,lane:2,laneMask:4},
    {note:"F",t:4.46,dur:0.18,lane:1,laneMask:2},
    {note:"C",t:4.74,dur:0.18,lane:0,laneMask:1},
    {note:"C",t:4.96,dur:0.18,lane:0,laneMask:1},
    {note:"F",t:5.17,dur:0.18,lane:1,laneMask:2},
    {note:"F",t:5.39,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:5.61,dur:0.18,lane:2,laneMask:4},
    {note:"G",t:5.83,dur:0.18,lane:2,laneMask:4},
    {note:"F",t:6.04,dur:0.18,lane:1,laneMask:2}
  ]},
  // --- Added Songs ---
  {title:"Love Me Do",artist:"The Beatles",chords:["G","C","D"],level:4,pattern:["D","D","U","U","D","U"],bpm:148,midi:"content/songs/midi/love_me_do.mid",progression:["G","G","C","G","G","G","C","G"]},
  {title:"Stand By Me",artist:"Ben E. King",chords:["A","D","E"],level:3,pattern:["D","D","U","U","D","U"],bpm:118,midi:"content/songs/midi/stand_by_me.mid",progression:["A","A","D","E","A","A","D","E"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"A",t:0.00,dur:0.35,lane:0,laneMask:1},
    {note:"A",t:0.51,dur:0.35,lane:0,laneMask:1},
    {note:"F#",t:1.02,dur:0.35,lane:1,laneMask:2},
    {note:"F#",t:1.52,dur:0.35,lane:1,laneMask:2},
    {note:"D",t:2.03,dur:0.35,lane:2,laneMask:4},
    {note:"D",t:2.54,dur:0.35,lane:2,laneMask:4},
    {note:"E",t:3.05,dur:0.35,lane:3,laneMask:8},
    {note:"E",t:3.56,dur:0.35,lane:3,laneMask:8},
    {note:"A",t:4.01,dur:0.35,lane:0,laneMask:1},
    {note:"A",t:4.52,dur:0.35,lane:0,laneMask:1},
    {note:"F#",t:5.03,dur:0.35,lane:1,laneMask:2},
    {note:"F#",t:5.53,dur:0.35,lane:1,laneMask:2},
    {note:"D",t:6.04,dur:0.35,lane:2,laneMask:4},
    {note:"D",t:6.55,dur:0.35,lane:2,laneMask:4},
    {note:"E",t:7.06,dur:0.35,lane:3,laneMask:8},
    {note:"E",t:7.57,dur:0.35,lane:3,laneMask:8}
  ]},
  ...
  {title:"Bad Moon Rising",artist:"CCR",chords:["D","A","G"],level:4,pattern:["D","D","U","U","D","U"],bpm:176,midi:"content/songs/midi/bad_moon_rising.mid",progression:["D","D","A","G","D","D","A","G"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"D",t:0.00,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:0.17,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:0.34,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:0.51,dur:0.12,lane:0,laneMask:1},
    {note:"G",t:0.68,dur:0.12,lane:2,laneMask:4},
    {note:"D",t:0.85,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:1.02,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:1.19,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:1.41,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:1.58,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:1.75,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:1.92,dur:0.12,lane:0,laneMask:1},
    {note:"G",t:2.09,dur:0.12,lane:2,laneMask:4},
    {note:"D",t:2.26,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:2.43,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:2.60,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:2.82,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:2.99,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:3.16,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:3.33,dur:0.12,lane:0,laneMask:1},
    {note:"G",t:3.50,dur:0.12,lane:2,laneMask:4},
    {note:"D",t:3.67,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:3.84,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:4.01,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:4.23,dur:0.12,lane:0,laneMask:1},
    {note:"D",t:4.40,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:4.57,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:4.74,dur:0.12,lane:0,laneMask:1},
    {note:"G",t:4.91,dur:0.12,lane:2,laneMask:4},
    {note:"D",t:5.08,dur:0.12,lane:0,laneMask:1},
    {note:"A",t:5.25,dur:0.12,lane:1,laneMask:2},
    {note:"D",t:5.42,dur:0.12,lane:0,laneMask:1}
  ]},
  ...
  {title:"Have You Ever Seen the Rain",artist:"CCR",chords:["C","G","Am","F"],level:7,pattern:["D","D","U","U","D","U"],bpm:116,midi:"content/songs/midi/have_you_ever_seen_the_rain.mid",progression:["Am","F","C","G","Am","F","C","C"]},
  {title:"Hotel California",artist:"Eagles",chords:["Am","E","G","D","F","C","Dm"],level:7,pattern:["D","x","U","x","U","D","x","U"],bpm:74,midi:"content/songs/midi/hotel_california.mid",progression:["Am","Am","E","E","G","G","D","D","F","F","C","C","Dm","Dm","E","E"]},
  {title:"Creep",artist:"Radiohead",chords:["G","B7","C","Cm"],level:8,pattern:["D","D","U","U","D","U"],bpm:92,midi:"content/songs/midi/creep.mid",progression:["G","G","B7","B7","C","C","Cm","Cm"]},
  ...
  // --- One-Chord Songs ---
  {title:"Tomorrow Never Knows",artist:"The Beatles",chords:["C"],level:4,pattern:["D","D","U","U","D","U"],bpm:125,midi:"content/songs/midi/tomorrow_never_knows.mid",progression:["C","C","C","C","C","C","C","C"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"C",t:0.00,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:0.24,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:0.48,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:0.72,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:0.96,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:1.20,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:1.44,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:1.68,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:1.98,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:2.22,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:2.46,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:2.70,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:2.94,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:3.18,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:3.42,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:3.66,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:3.96,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:4.20,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:4.44,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:4.68,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:4.92,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:5.16,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:5.40,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:5.64,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:5.94,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:6.18,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:6.42,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:6.66,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:6.90,dur:0.20,lane:0,laneMask:1},
    {note:"C",t:7.14,dur:0.20,lane:0,laneMask:1},
    {note:"B",t:7.38,dur:0.20,lane:1,laneMask:2},
    {note:"C",t:7.62,dur:0.20,lane:0,laneMask:1}
  ]},
  ...
  {title:"Peter Gunn",artist:"Duane Eddy",chords:["E"],level:2,pattern:["D","U","D","U","D","U","D","U"],bpm:130,midi:"content/songs/midi/peter_gunn.mid",progression:["E","E","E","E","E","E","E","E"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    ...
    {note:"B",t:1.45,dur:0.34,lane:3,laneMask:8},
    {note:"A",t:1.92,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:2.38,dur:0.28,lane:2,laneMask:4},
    {note:"E",t:2.86,dur:0.40,lane:0,laneMask:1},
    {note:"E",t:3.36,dur:0.30,lane:0,laneMask:1},
    {note:"G",t:3.84,dur:0.28,lane:2,laneMask:4},
    {note:"A",t:4.33,dur:0.28,lane:1,laneMask:2},
    {note:"B",t:4.80,dur:0.34,lane:3,laneMask:8},
    {note:"A",t:5.28,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:5.74,dur:0.28,lane:2,laneMask:4},
    {note:"E",t:6.21,dur:0.42,lane:0,laneMask:1},
    {note:"E",t:6.72,dur:0.30,lane:0,laneMask:1},
    {note:"G",t:7.20,dur:0.28,lane:2,laneMask:4},
    {note:"A",t:7.68,dur:0.28,lane:1,laneMask:2},
    {note:"B",t:8.15,dur:0.34,lane:3,laneMask:8},
    {note:"A",t:8.62,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:9.08,dur:0.28,lane:2,laneMask:4},
    {note:"E",t:9.56,dur:0.40,lane:0,laneMask:1},
    {note:"E",t:10.06,dur:0.30,lane:0,laneMask:1},
    {note:"G",t:10.54,dur:0.28,lane:2,laneMask:4},
    {note:"A",t:11.03,dur:0.28,lane:1,laneMask:2},
    {note:"B",t:11.50,dur:0.34,lane:3,laneMask:8},
    {note:"A",t:11.97,dur:0.28,lane:1,laneMask:2},
  ...
  {title:"Seven Nation Army",artist:"The White Stripes",chords:["E","G","D","C","B"],level:3,pattern:["D","x","D","U","x","U","D","U"],bpm:124,progression:["E","E","E","E","E","E","E","E"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    ...
    {note:"E",t:1.47,dur:0.30,lane:2,laneMask:4},
    {note:"D",t:1.98,dur:0.32,lane:3,laneMask:8},
    {note:"C",t:2.52,dur:0.32,lane:2,laneMask:4},
    {note:"B",t:3.02,dur:0.34,lane:1,laneMask:2},
    {note:"E",t:3.55,dur:0.48,lane:0,laneMask:1},
    {note:"E",t:4.04,dur:0.34,lane:2,laneMask:4},
    {note:"E",t:4.52,dur:0.30,lane:2,laneMask:4},
    {note:"G",t:5.02,dur:0.34,lane:0,laneMask:1},
    {note:"E",t:5.51,dur:0.30,lane:2,laneMask:4},
    {note:"D",t:6.02,dur:0.32,lane:3,laneMask:8},
    {note:"C",t:6.56,dur:0.32,lane:2,laneMask:4},
  ...
  // --- Two-Chord Songs ---
  {title:"Eleanor Rigby",artist:"The Beatles",chords:["Em","C"],level:4,pattern:["D","D","U","U","D","U"],bpm:138,midi:"content/songs/midi/eleanor_rigby.mid",progression:["Em","Em","C","C","Em","Em","C","Em"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"E",t:0.00,dur:0.18,lane:0,laneMask:1},
    {note:"F#",t:0.22,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:0.43,dur:0.18,lane:2,laneMask:4},
    {note:"A",t:0.65,dur:0.18,lane:3,laneMask:8},
    {note:"G",t:0.87,dur:0.18,lane:2,laneMask:4},
    {note:"F#",t:1.09,dur:0.18,lane:1,laneMask:2},
    {note:"E",t:1.30,dur:0.18,lane:0,laneMask:1},
    {note:"D",t:1.52,dur:0.18,lane:4,laneMask:16},
    {note:"E",t:1.80,dur:0.18,lane:0,laneMask:1},
    {note:"F#",t:2.02,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:2.23,dur:0.18,lane:2,laneMask:4},
    {note:"A",t:2.45,dur:0.18,lane:3,laneMask:8},
    {note:"G",t:2.67,dur:0.18,lane:2,laneMask:4},
    {note:"F#",t:2.89,dur:0.18,lane:1,laneMask:2},
    {note:"E",t:3.10,dur:0.18,lane:0,laneMask:1},
    {note:"D",t:3.32,dur:0.18,lane:4,laneMask:16},
    {note:"E",t:3.60,dur:0.18,lane:0,laneMask:1},
    {note:"F#",t:3.82,dur:0.18,lane:1,laneMask:2},
    {note:"G",t:4.03,dur:0.18,lane:2,laneMask:4},
    {note:"A",t:4.25,dur:0.18,lane:3,laneMask:8},
    {note:"G",t:4.47,dur:0.18,lane:2,laneMask:4},
    {note:"F#",t:4.69,dur:0.18,lane:1,laneMask:2},
    {note:"E",t:4.90,dur:0.18,lane:0,laneMask:1},
    {note:"D",t:5.12,dur:0.18,lane:4,laneMask:16}
  ]},
  {title:"Royals",artist:"Lorde",chords:["C","D"],level:4,pattern:["D","D","U","U","D","U"],bpm:85,midi:"content/songs/midi/royals.mid",progression:["C","C","D","D","C","C","D","D"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"D",t:0.00,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:0.35,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:0.71,dur:0.28,lane:0,laneMask:1},
    {note:"G",t:1.06,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:1.41,dur:0.28,lane:1,laneMask:2},
    {note:"D",t:1.76,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:2.14,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:2.49,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:2.85,dur:0.28,lane:0,laneMask:1},
    {note:"G",t:3.20,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:3.55,dur:0.28,lane:1,laneMask:2},
    {note:"D",t:3.90,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:4.28,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:4.63,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:4.99,dur:0.28,lane:0,laneMask:1},
    {note:"G",t:5.34,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:5.69,dur:0.28,lane:1,laneMask:2},
    {note:"D",t:6.04,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:6.42,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:6.77,dur:0.28,lane:0,laneMask:1},
    {note:"D",t:7.13,dur:0.28,lane:0,laneMask:1},
    {note:"G",t:7.48,dur:0.28,lane:1,laneMask:2},
    {note:"G",t:7.83,dur:0.28,lane:1,laneMask:2},
    {note:"D",t:8.18,dur:0.28,lane:0,laneMask:1}
  ]},
  {title:"What I Got",artist:"Sublime",chords:["D","G"],level:4,pattern:["D","U","D","U","D","U","D","U"],bpm:94,midi:"content/songs/midi/what_i_got.mid",progression:["D","D","G","G","D","D","G","G"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"D",t:0.00,dur:0.25,lane:0,laneMask:1},
    {note:"D",t:0.32,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:0.64,dur:0.25,lane:1,laneMask:2},
    {note:"G",t:0.96,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:1.27,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:1.59,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:1.91,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:2.23,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:2.58,dur:0.25,lane:0,laneMask:1},
    {note:"D",t:2.90,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:3.22,dur:0.25,lane:1,laneMask:2},
    {note:"G",t:3.54,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:3.85,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:4.17,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:4.49,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:4.81,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:5.16,dur:0.25,lane:0,laneMask:1},
    {note:"D",t:5.48,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:5.80,dur:0.25,lane:1,laneMask:2},
    {note:"G",t:6.12,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:6.43,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:6.75,dur:0.25,lane:1,laneMask:2},
    {note:"D",t:7.07,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:7.39,dur:0.25,lane:1,laneMask:2}
  ]},
  {title:"Whole Lotta Love",artist:"Led Zeppelin",chords:["E","A"],level:3,pattern:["D","D","U","U","D","U"],bpm:92,midi:"content/songs/midi/whole_lotta_love.mid",progression:["E","E","A","A","E","E","A","E"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"E",t:0.00,dur:0.25,lane:0,laneMask:1},
    {note:"E",t:0.33,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:0.65,dur:0.25,lane:2,laneMask:4},
    {note:"A",t:0.98,dur:0.25,lane:3,laneMask:8},
    {note:"A#",t:1.30,dur:0.25,lane:4,laneMask:16},
    {note:"A",t:1.63,dur:0.25,lane:3,laneMask:8},
    {note:"G",t:1.95,dur:0.25,lane:2,laneMask:4},
    {note:"E",t:2.28,dur:0.25,lane:0,laneMask:1},
    {note:"D",t:2.60,dur:0.25,lane:1,laneMask:2},
    {note:"E",t:2.93,dur:0.25,lane:0,laneMask:1},
    {note:"E",t:3.28,dur:0.25,lane:0,laneMask:1},
    {note:"E",t:3.61,dur:0.25,lane:0,laneMask:1},
    {note:"G",t:3.93,dur:0.25,lane:2,laneMask:4},
    {note:"A",t:4.26,dur:0.25,lane:3,laneMask:8},
    {note:"A#",t:4.58,dur:0.25,lane:4,laneMask:16},
    {note:"A",t:4.91,dur:0.25,lane:3,laneMask:8},
    {note:"G",t:5.23,dur:0.25,lane:2,laneMask:4},
    {note:"E",t:5.56,dur:0.25,lane:0,laneMask:1},
    {note:"D",t:5.88,dur:0.25,lane:1,laneMask:2},
    {note:"E",t:6.21,dur:0.25,lane:0,laneMask:1}
  ]},
  ...
  {title:"Moves Like Jagger",artist:"Maroon 5",chords:["Em","Bm"],level:8,pattern:["D","x","D","U","x","U","D","U"],bpm:128,midi:"content/songs/midi/moves_like_jagger.mid",progression:["Em","Em","Bm","Bm","Em","Em","Bm","Bm"]},
  ...
  {title:"Chain of Fools",artist:"Aretha Franklin",chords:["Cm"],level:8,pattern:["D","U","D","U","D","U","D","U"],bpm:112,midi:"content/songs/midi/chain_of_fools.mid",progression:["Cm","Cm","Cm","Cm","Cm","Cm","Cm","Cm"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"C",t:0.00,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:0.27,dur:0.22,lane:0,laneMask:1},
    {note:"Eb",t:0.54,dur:0.22,lane:1,laneMask:2},
    {note:"F",t:0.80,dur:0.22,lane:2,laneMask:4},
    {note:"Eb",t:1.07,dur:0.22,lane:1,laneMask:2},
    {note:"C",t:1.34,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:1.61,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:1.93,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:2.20,dur:0.22,lane:0,laneMask:1},
    {note:"Eb",t:2.47,dur:0.22,lane:1,laneMask:2},
    {note:"F",t:2.73,dur:0.22,lane:2,laneMask:4},
    {note:"Eb",t:3.00,dur:0.22,lane:1,laneMask:2},
    {note:"C",t:3.27,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:3.54,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:3.86,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:4.13,dur:0.22,lane:0,laneMask:1},
    {note:"Eb",t:4.40,dur:0.22,lane:1,laneMask:2},
    {note:"F",t:4.66,dur:0.22,lane:2,laneMask:4},
    {note:"Eb",t:4.93,dur:0.22,lane:1,laneMask:2},
    {note:"C",t:5.20,dur:0.22,lane:0,laneMask:1},
    {note:"C",t:5.47,dur:0.22,lane:0,laneMask:1}
  ]},
  {title:"Get Up Stand Up",artist:"Bob Marley",chords:["Cm"],level:8,pattern:["D","x","U","x","U","D","x","U"],bpm:100,midi:"content/songs/midi/get_up_stand_up.mid",progression:["Cm","Cm","Cm","Cm","Cm","Cm","Cm","Cm"],mode:"riff",preferredPerformanceArrangement:"lead",leadNotes:[
    {note:"C",t:0.00,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:0.30,dur:0.24,lane:0,laneMask:1},
    {note:"Eb",t:0.60,dur:0.24,lane:1,laneMask:2},
    {note:"G",t:0.90,dur:0.24,lane:2,laneMask:4},
    {note:"Eb",t:1.20,dur:0.24,lane:1,laneMask:2},
    {note:"C",t:1.50,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:1.84,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:2.14,dur:0.24,lane:0,laneMask:1},
    {note:"Eb",t:2.44,dur:0.24,lane:1,laneMask:2},
    {note:"G",t:2.74,dur:0.24,lane:2,laneMask:4},
    {note:"Eb",t:3.04,dur:0.24,lane:1,laneMask:2},
    {note:"C",t:3.34,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:3.68,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:3.98,dur:0.24,lane:0,laneMask:1},
    {note:"Eb",t:4.28,dur:0.24,lane:1,laneMask:2},
    {note:"G",t:4.58,dur:0.24,lane:2,laneMask:4},
    {note:"Eb",t:4.88,dur:0.24,lane:1,laneMask:2},
    {note:"C",t:5.18,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:5.52,dur:0.24,lane:0,laneMask:1},
    {note:"C",t:5.82,dur:0.24,lane:0,laneMask:1},
    {note:"Eb",t:6.12,dur:0.24,lane:1,laneMask:2},
    {note:"G",t:6.42,dur:0.24,lane:2,laneMask:4},
    {note:"Eb",t:6.72,dur:0.24,lane:1,laneMask:2},
    {note:"C",t:7.02,dur:0.24,lane:0,laneMask:1}
  ]},
  {title:"Music",artist:"Madonna",chords:["Gm"],level:8,pattern:["D","x","D","U","x","U","D","U"],bpm:120,midi:"content/songs/midi/music.mid",progression:["Gm","Gm","Gm","Gm","Gm","Gm","Gm","Gm"]}
];
...
var GUITAR_SESSIONS=[
  ...
  // ── Capo Sessions ──
  {num:23,title:"Hello, Capo",level:4,bpm:80,
  ...
  {num:24,title:"Shape Detective",level:4,bpm:80,
  ...
  {num:25,title:"Song in a New Key",level:5,bpm:85,
