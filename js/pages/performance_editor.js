...
function performanceEditorPage() {
  ...
  var chart = editorView.chart || sc.r("performEditorChart");
  ...
  var editorLibrary = editorView.library || sc.r("performEditorLibrary") || [];
