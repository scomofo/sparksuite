...
(function() {
  ...
  function sessionSummaryRender(opts) {
    ...
    return '<div class="showroom-root with-bg">'
         + '<div class="woodgrain-overlay" aria-hidden="true"></div>'
         ...
         + '<div class="showroom-canvas" style="position:relative;z-index:1">'
           + '<div class="showroom-summary-hero-refined">'
             + '<div class="showroom-summary-medal-container">'
               + '<div class="showroom-summary-medal-bg-glow" aria-hidden="true"></div>'
               + '<div class="showroom-summary-medal-circle showroom-ember-glow">'
                 + '<span class="material-symbols-outlined fill">workspace_premium</span>'
               + '</div>'
             + '</div>'
             + '<h1 class="showroom-summary-h-hero">Session Complete!</h1>'
             + '<p class="showroom-summary-sub-refined">' + escHtml(subtitle) + '</p>'
           + '</div>'
           + '<div class="showroom-summary-bento">'
             + '<div class="showroom-summary-card-xp">'
               + '<div class="showroom-summary-xp-glow" aria-hidden="true"></div>'
               + '<div><span class="showroom-summary-label-muted">XP Earned</span>'
                 + '<div class="showroom-summary-xp-val-row"><span class="showroom-summary-xp-val">+' + xp + '</span><span class="showroom-summary-xp-tag">XP</span></div></div>'
               + '<div class="showroom-summary-xp-icon-wrap showroom-carved-inset">'
             ...
             + '</div>'
             + '<div class="showroom-summary-card-square streak">'
               + '<div class="showroom-summary-fire-container"><span class="material-symbols-outlined fill showroom-summary-fire-icon">local_fire_department</span><div class="showroom-summary-fire-bg-glow" aria-hidden="true"></div></div>'
               + '<span class="showroom-summary-stat-num">' + streak + '</span>'
               + '<span class="showroom-summary-label-muted tiny">Day Streak</span>'
             + '</div>'
             + '<div class="showroom-summary-card-lesson-glass">'
               + '<div class="showroom-summary-lesson-content">'
                 + '<div class="showroom-summary-lesson-cover">' + thumb + '</div>'
                 + '<div><span class="showroom-summary-lesson-eyebrow-alt">CURRENT LESSON</span>'
                   + '<h3 class="showroom-summary-lesson-title-alt">' + escHtml(lessonTitle) + '</h3>'
                   + '<p class="showroom-summary-lesson-meta-alt">' + escHtml(lessonMeta) + '</p></div>'
               + '</div>'
             + '</div>'
           + '</div>'
           + '<div class="showroom-summary-actions-refined">'
             + '<button class="showroom-summary-btn-primary showroom-ember-glow" onclick="' + backToHome() + '">CONTINUE</button>'
             + '<button class="showroom-summary-btn-outline" onclick="act(\'showroomStartPerf\')">REPLAY SESSION</button>'
           + '</div>'
         + '</div>'
         + bottomNav(navItems, "practice")
         + '</div>';
