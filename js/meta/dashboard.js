function dashboardPage(){
  ...
  h += '<div class="card-section-heading">Progress Dashboard</div>';
  ...
  h += '<div class="card">';
  h += '<div class="card-section-heading">Daily Challenges</div>';
  ...
  h += '<div class="card">';
  h += '<div class="card-section-heading">Weekly Goals</div>';
  ...
  h += '<div class="card">';
  h += '<div class="card-section-heading">Skill Tree</div>';
