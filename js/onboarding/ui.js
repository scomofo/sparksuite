...
function renderOnboardingMidiSetup(){
  ...
  h += '<button onclick="act(\'onboardingMarkMidiDone\')">Mark Done</button>';
  h += '</div>';
  return h;
}
...
function renderOnboardingCalibration(){
  ...
  h += '<button onclick="act(\'onboardingMarkCalibrationDone\')">Mark Done</button>';
  h += '</div>';
  return h;
}
...
function renderOnboardingNav(){
  ...
  h += '<button onclick="act(\'onboardingPrevStep\')">Back</button> ';
  h += '<button onclick="act(\'onboardingNextStep\')">Next</button>';
  h += '</div>';
  return h;
}
