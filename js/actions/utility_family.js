(function() {
  ...
  function handleUtilityAction(a, v) {
    ...
    if (a === "importMidiDesktop") {
      if (typeof importMidiDesktopAware === "function") Promise.resolve(importMidiDesktopAware()).catch(function() { if (typeof render === "function") render(); });
      return true;
    }
    ...
    if (a === "importMidiFile") {
      if (typeof handleMidiImport === "function") Promise.resolve(handleMidiImport(v)).catch(function() { if (typeof render === "function") render(); });
      return true;
    }
